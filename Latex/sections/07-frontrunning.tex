...
% TODO: reread this for ethics and some other details: https://www.cryptofrens.info/p/enablement-of-mev-and-the-morals
...
\begin{figure}[h]
    \centering
{\caption[Front-running Taxonomy]{Front-running Taxonomy}\label{fig:frontrunningtaxonomy}}
...
\input{tables/frontrunning-table.tex}
...
\subsection{Confidentiality}\label{sec:confidentiality}
...
\subsection{Embracing Front-running.}\label{MEVfrontrunning} %TODO: update with more details on the flashbots relayer stuff
...
\section{Concluding Remarks} %TODO: update this to related back to the theme and review the ethics section as well.
