...
In this chapter, we aim to address \textbf{RQ3:} \textit{How do front-running attacks exploit the decentralized nature of blockchain applications, what strategies can mitigate these attacks, and what are the (ethical) implications of these strategies?} We provide a comprehensive study of front-running attacks on blockchain applications, focusing on decentralized applications (DApps) deployed on Ethereum. We categorize the attacks based on the type of DApp and the type of the front-running attacks based on our taxonomy. We conclude by discussing the strategies to mitigate these attacks and the ethical implications of these strategies.
