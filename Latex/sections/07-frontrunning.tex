...
In this chapter, we aim to address \textbf{RQ2:} \textit{There has been suggestions that front-running attacks exploit the decentralized nature of blockchains. How prevalent are these attacks? What are the strategies to mitigate them?} We provide a comprehensive study of front-running attacks on blockchain applications, focusing on decentralized applications (DApps) deployed on Ethereum. We categorize the attacks based on the type of DApp and the type of the front-running attacks based on our taxonomy. We conclude by discussing the strategies to mitigate these attacks and the ethical implications of these strategies.
...
\section{Follow-up Work}\label{sec:frontrunning:followup}
