...
Following our audit framework, after the cryptoassets' existence and ownership are verified, at an established valuation, auditors must obtain reasonable assurance that the internal controls of the client are effective. In the context of cryptoassets, this is challenging because the adequate internal controls are novel to the auditors, often not well documented and are not always securely automated. Internal Controls are encapsulated in operational processes and policies, access control, (private) key management, and IT infrastructure. 
