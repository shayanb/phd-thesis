...
In this chapter, in order to answer \textbf{RQ4}, in addition to discussing the oracle problem, we described a specialized modular framework to analyze oracles. After our systematization, we present the following discussion points and lessons learned from our work. 
