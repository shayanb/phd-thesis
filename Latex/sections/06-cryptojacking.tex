...
%TODO: a paragraph here glueing this chapter to the theme of the thesis
...
%TODO:
% - No one has mentioned this but here’s another citation has answered those question?
% - either in the discussion or Follow up work: we were the first paper on cyrptojacking, since there are 200 papers on this topic and here are the list of the main research avenues are, we raised these questions that these papers 
%     - in text if needed : we discuss this on the follow up work
...
%TODO: add some more on financial analysis

%TODO: look for any ethical discussions on cryptojacking


\section{Conclusion}
% - Conclusion —> tie it back to overall thesis, layout future work, glue it to the next chapter
