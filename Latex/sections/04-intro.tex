...
In Chapter~\ref{sec:auditing}, we study the auditing of blockchain-based assets and the systematic challenges a company might have to properly audit their crypto-assets. TODO %TODO: fill this in
...
%Todo: read this again and see if it makes sense
