...
%     \begin{tabular}{|p{3.25cm}|p{6.25cm}|p{6.25cm}|}
%         \hline
%         \rowcolor{lightgray}
%         \textbf{Chapter} & \textbf{Technical Nuance} & \textbf{Unforeseen Consequence} \\ \hline
        
%         \ref{sec:cryptojacking} - Crypto-jacking &
%         Using \textbf{browser-based mining} as an alternative to online ads &
%         \textbf{Covert CPU hijacking} for \newline unauthorized mining \\ \hline
        
%         \ref{sec:frontrunning} - Front-running &
%         \textbf{Transparency} and permissionless nature of decentralized systems &
%         \textbf{Transaction reordering} for \newline value extraction \\ \hline
        
%         \ref{sec:oracles} - Oracles &
%         Integrating \textbf{off-chain data} into smart contracts via oracles &
%         \textbf{Market manipulation} due to \newline implementation issues \\ \hline
        
%         \ref{sec:auditing} - Auditing &
%         Public \textbf{decentralized \newline cryptoassets} and ledgers &
%         Complete \textbf{validation} requiring \newline technical expertise \\ \hline
%     \end{tabular}
%     \end{adjustbox}
%     \caption[Technical Nuances and Their Unforeseen Consequences]{Technical Nuances and Their Unforeseen Consequences in Blockchain Systems for Each Chapter of This Thesis.}
...
\begin{table}[t]
    ...
    \begin{tabular}{|p{3cm}|p{4.25cm}|p{5.25cm}|p{5cm}|}
        ...
        Websites can serve up mining scripts to extract value at their users' expense  &
        ...
        Users and validators manipulate transaction ordering to extract value at users' expense  &
        ...
        Adversaries can profit by manipulating oracles &
        ...
        Technical issues with crypto-assets can impact the financials of the firms that hold them. &
...
% % @Jeremy: TODO: This table needs a review
% \begin{table}[t]
%     \centering
%     \begin{adjustbox}{width=\textwidth}
%     \begin{tabular}{|p{3.25cm}|p{6.25cm}|p{6.25cm}|}
%         \hline
%         \rowcolor{lightgray}
%     \textbf{Chapter} & \textbf{Blockchain System} & \textbf{Non-Blockchain System} \\ \hline
%     \ref{sec:cryptojacking} - Crypto-jacking &
%     Abusing users' resources to mine cryptocurrencies without them realizing &
%     Nodes and mining are deliberately deployed \\ \hline

%     \ref{sec:frontrunning} - Front-running &
%     Transactions are visible to all before confirmation, enabling value extraction &
%     Transactions are only visible to the server that processes them \\ \hline

%     \ref{sec:oracles} - Oracles &
%     Smart contracts rely on oracles for off-chain data &
%     Applications have direct access to data/APIs \\ \hline

%     \ref{sec:auditing} - Auditing &
%     Requires new procedures to verify cryptoassets, although similar to traditional systems &
%     Financial audit procedures are well-developed \\ \hline
% \end{tabular}
% \end{adjustbox}
% \caption[The Technical Nuances of Blockchain Systems v.s. Traditional Systems.]{The Technical Nuances of Blockchain Systems v.s. Traditional Systems for Each Chapter of This Thesis.}
% \label{tab:chapters:comparison}
% \end{table}
...
\paragraph{RQ2:} \textit{There has been suggestions that front-running attacks exploit the decentralized nature of blockchains. How prevalent are these attacks? What are the strategies to mitigate them?}
