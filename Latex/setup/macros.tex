...
\newcommand{\headrow}[1]{\multicolumn{1}{c}{\adjustbox{angle=90,lap=\width-0.9em}{#1}}}
...
% TODO remove this after finding the unicode character 
\DeclareUnicodeCharacter{200A}{!!!FIX ME!!!} 
\DeclareUnicodeCharacter{200B}{!!!FIX ME!!!} 
